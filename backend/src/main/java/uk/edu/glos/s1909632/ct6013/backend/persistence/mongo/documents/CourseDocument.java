...
final public class CourseDocument {
    final public static class CourseModuleMongoEntity {
        @BsonId
        private ObjectId id;
        ...
        public CourseModuleMongoEntity() {}
        ...
        public boolean equals(Object o) {
            ...
            CourseModuleMongoEntity that = (CourseModuleMongoEntity) o;
    ...
    @BsonProperty
    private Set<CourseModuleMongoEntity> modules;
    ...
    public void setStudentIds(Set<ObjectId> studentIds) {
        this.studentIds = studentIds;
    }

    public Set<CourseModuleMongoEntity> getModules() {
        if (modules == null) modules = new HashSet<>();
        return modules;
    }

    public void setModules(
            Set<CourseModuleMongoEntity> modules) {
