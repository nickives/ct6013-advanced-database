--------------------------------------------------------
--  File created - Sunday-November-20-2022   
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Table COURSE_MODULE
--------------------------------------------------------

  CREATE TABLE "S1909632"."COURSE_MODULE" 
   (	"COURSE_ID" NUMBER(*,0), 
	"MODULE_ID" NUMBER(*,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT);
--------------------------------------------------------
--  DDL for Index SYS_C00193929
--------------------------------------------------------

  CREATE UNIQUE INDEX "S1909632"."SYS_C00193929" ON "S1909632"."COURSE_MODULE" ("COURSE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT);
...
--------------------------------------------------------
  ...
  ALTER TABLE "S1909632"."COURSE_MODULE" ADD PRIMARY KEY ("COURSE_ID")
...
--------------------------------------------------------
--  Ref Constraints for Table COURSE_MODULE
--------------------------------------------------------

  ALTER TABLE "S1909632"."COURSE_MODULE" ADD CONSTRAINT "COURSE_MODULE_COURSE_ID_FK" FOREIGN KEY ("COURSE_ID")
	  REFERENCES "S1909632"."COURSE" ("ID") ENABLE;
  ALTER TABLE "S1909632"."COURSE_MODULE" ADD CONSTRAINT "COURSE_MODULE_MODULE_ID_FK" FOREIGN KEY ("MODULE_ID")
